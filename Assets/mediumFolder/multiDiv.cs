...
public class multiDiv : MonoBehaviour
{
    ...
    void scramble()
    {
        ...
        if (qNum == 0)
        {
            equationString.text = (2 + " * " + 10 + " / " + 5); //Easy
            endAmount = 4;
        }
        else if (qNum == 1)
        {
            equationString.text = (4 + " * " + 9 + " / " + 6); //Medium
            endAmount = 6;
        }
        else if (qNum == 2)
        {
            equationString.text = (7 + " * " + 6 + " / " + 3); //Hard
            endAmount = 14;
        }
        else if (qNum == 3)
        {
            equationString.text = (4 + " / " + 2 + " * " + 3); //Easy
            endAmount = 2;
        }
        else if (qNum == 4)
        {
            equationString.text = (9 + " / " + 3 + " * " + 7); //Medium
            endAmount = 21;
        }
        else if (qNum == 5)
        {
            equationString.text = (8 + " / " + 2 + " * " + 6); //Hard
            endAmount = 24;
        }
